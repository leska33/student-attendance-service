...
public interface GradeRepository extends JpaRepository<Grade, Long> {
    ...
    @Query("select g from Grade g join g.discipline d where d.name = :disciplineName")
    ...
    @Query("select g from Grade g join g.student s where s.lastName = :studentLastName")
